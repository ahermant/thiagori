export default {
    ...
    general_information_photos_videos_content: '<p>Nous autorisons et encourageons les invités à partager leurs photos et vidéos sur leurs réseaux sociaux, nous vous demanderions simplement de tagger chaque photo avec le hashtag de notre mariage <em><strong>#thiagori&nbsp;</strong></em>dans le but de nous aider à les retrouver! Merci <span lang="fr-FR">😊</span></p>',
    ...
    general_information_weather_content: '<p>Le 19 Novembre au Brésil ça sera le début de l’été.&nbsp;</p><p>D’habitude, à cette période de l’année, les températures sont élevées et il est également possible qu’il pleuve (nous aurons une partie couverte).</p><p>Svp, veuillez planifier une tenue adéquate ainsi que tout ce dont vous auriez besoin pour votre confort comme par exemple de la crème solaire (au Brésil, même à l’ombre, on peut prendre des coups de soleil).</p><p>Aussi, la cérémonie, le repas et la fête se passeront au même endroit, sur la plage. Nous conseillons aux invitées de <u>ne pas</u> porter de talons mais plutôt des sandales plates ou de rester pieds nus.</p>',
    ...
    hotel_list_vilha_velha: 'Hotels à Vilha Velha (ville des parents de Thiago, à côté de Vitória)',
    hotel_list_vitoria: 'Hotels à Vitória (grande ville la plus proche)',
    hotel_list_nova_almeida: 'Hôtels à Nova Almeida (lieu de la cérémonie)',
