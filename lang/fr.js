export default {
    ...
    hotel_list_vitoria: 'Hotels proches de Vitória (grande ville la plus proche)',
    hotel_list_nova_almeida: 'Hôtels proches de Nova Almeida (lieu de la cérémonie)',
