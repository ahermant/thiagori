export default {
    ...
    general_information_weather_content: '<p>Le 28 Novembre au Brésil ça sera le début de l’été.&nbsp;</p><p>D’habitude, à cette période de l’année, les températures sont élevées et il est également possible qu’il pleuve (nous aurons une partie couverte).</p><p>Svp, veuillez planifier une tenue adéquate ainsi que tout ce dont vous auriez besoin pour votre confort comme par exemple de la crème solaire (au Brésil, même à l’ombre, on peut prendre des coups de soleil).</p><p>Aussi, la cérémonie, le repas et la fête se passeront au même endroit, sur la plage. Nous conseillons aux invitées de <u>ne pas</u> porter de talons mais plutôt des sandales plates ou de rester pieds nus.</p>',
